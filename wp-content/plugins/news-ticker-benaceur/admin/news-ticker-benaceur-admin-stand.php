...
.sm_benaceurlist_caps_input-ntb input[type="text"]{color:#5D5D5D;font-weight:bold;width:60%;height:32px;border-radius:10px;height:30px;
...
.button-secondary-ntb-hid-1:active {
  ...
  #sub-ntbMyplugins a:link,#sub-ntbMyplugins a:visited {color:#5F5F5F;}
  #sub-ntbMyplugins a:hover {color:#000;text-decoration:none;
