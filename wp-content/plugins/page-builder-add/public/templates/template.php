...
<?php if ($current_postType == 'post' || $current_postType == 'page' || $isShortCodeTemplate == true ){ echo "<div class='ulpb_PageBody ulpb_PageBody_$current_pageID'>";} else{ echo "<body class='ulpb_PageBody ulpb_PageBody_$current_pageID'>";  echo "<div id='fullPageBgOverlay_$current_pageID' style='height: 100%; top: 0 !important; bottom:0 !important; left: 0 !important; right:0 !important;  width: 100%; position: fixed;'></div>";   }     ?>
      ...
      if (isset($rowData['bgSTop']) ) {
        ...
        if ($bgSTop != 'false') {
          ...
          if ($bgShapeTop != '') {
            ...
            $renderredShapeHTML = 
            '<div class="bgShapes bgShapeTop-'.$row["rowID"].'"  style="overflow: hidden; position: absolute; left: 0; width: 100%; direction: ltr; top: 0px; text-align:center; '.$onFront.' '.$invertTransform.' ">'.
      ...
      if (isset($rowData['bgSBottom']) ) {
        ...
        if ($bgSBottom != 'false') {
          ...
          if ($bgShapeBottom != '') {
            ...
            $renderredShapeHTML = 
            '<div class="bgShapes bgShapeBottom-'.$row["rowID"].'"  style="overflow: hidden; position: absolute; left: 0; width: 100%; direction: ltr;  bottom: 0px; transform: rotate(180deg); text-align:center; '.$onFront.' '.$invertTransform.' ">'.
