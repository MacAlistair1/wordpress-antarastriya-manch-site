...
$('#side-sortables').append('<br><span style="font-size:16px"> If you are facing 404 page not found error :   <a href="http://pluginops.com/fix-404-page-not-found-error-wordpress/" target="_blank"> Here is how to fix it </a></span> <br>');
...
$('#side-sortables').append('<br> <br><span style="font-size:15px"> Love this plugin ? Post your love here :   <a href="https://wordpress.org/support/plugin/page-builder-add/reviews/?rate=5#new-post" target="_blank"> Send Some Love </a></span>');
