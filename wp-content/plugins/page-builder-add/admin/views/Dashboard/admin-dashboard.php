...
<div id="ulpb_dash_container">
	...
	<div class="tabs">
        ...
        <br>
        <br>
         <a target="_blank" href="https://pluginops.com/fix-404-page-not-found-error-wordpress/" style="font-size:14px; font-weight: bold; background: #e3e3e3; padding: 5px 10px; line-height: 2em;"> Before creating a Landing Page - Please reset your permalink structure to fix page not found error. </a>
        </div>
