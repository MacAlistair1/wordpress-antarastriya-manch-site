	...
	<div class="pbp_form" style="width: 650px !important; margin-left: 50px;">
		<form id="ulpb_settings_form">
			<div style="display:; width:100%;">
				...
				<p style="font-size: 13px;">These scripts will be added in head section of all your landing pages & pages created using PluginOps Page Builder.</p>
				<br>
			</div>
			<div style="display:; width:100%;">
			<?php
			...
			?>
			<textarea id="TrackingScriptsField" class="TrackingScriptsField" name="TrackingScriptsField" style="width:600px; height: 500px;"><?php echo $ulpb_global_tracking_scripts; ?></textarea>
			</div>
			<br>
			<br>
		</form>
		<button id="ulpb_settings_form_submit" class="publishBtn"  style="height: 35px; width: 120px; ">Save Changes</button>
