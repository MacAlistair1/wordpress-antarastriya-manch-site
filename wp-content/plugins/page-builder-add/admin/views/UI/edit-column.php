        ...
        <div class="tab-content">
          <div id="tabColumnOptions" class="tab active" style="min-height:400px;">
                            ...
                            <div id="pluginops_input_tabs" class="popbinputTabsWrapper POPBInputNormalRow">
                                ...
                                <div class="popb_input_tabContent">
                                    <div class="content_popb_tab_1 popb_tab_content popb_col_fields_container ">
                                        ...
                                        <br>
                                        <label>Color :</label>
                                        <input type="text" name="columnBgColor" class="color-picker_btn_two columnBgColor" data-alpha='true' id="columnBgColor" value=''>
                                        <br>
                                        <br>
                                        <label>Image :</label>
                                    ...
                                    <div class="content_popb_tab_2 popb_tab_content popb_col_fields_container ">
                                        ...
                                        <input type="text" name="colGradientColorFirst" class="color-picker_btn_two colGradientColorFirst" data-alpha='true' id="colGradientColorFirst" value=''>
                                        <p>Location</p>
                                        ...
                                        <input type="text" name="colGradientColorSecond" class="color-picker_btn_two colGradientColorSecond" data-alpha='true' id="colGradientColorSecond" value=''>
                                        <p>Location</p>
                            ...
                            <div id="pluginops_input_tabs" class="popbinputTabsWrapper POPBInputNormalcol POPBInputHovercol">
                                ...
                                <div class="popb_input_tabContent">
                                    <div class="content_popb_tab_1 popb_tab_content popb_col_fields_container">
                                        ...
                                        <br>
                                        <label>Color :</label>
                                        <input type="text" name="colBgColorHover" class="color-picker_btn_two colBgColorHover" data-alpha='true' id="colBgColorHover" value=''>
                                        <br>
                                    </div>
                                    <div class="content_popb_tab_2 popb_tab_content popb_col_fields_container">
                                        <br>
                                        ...
                                        <br>
                                        <label>First Color </label>
                                        <input type="text" name="colGradientColorFirstHover" class="color-picker_btn_two colGradientColorFirstHover" data-alpha='true' id="colGradientColorFirstHover" value=''>
                                        <p>Location</p>
                                        ...
                                        <br>
                                        <label>Second Color </label>
                                        <input type="text" name="colGradientColorSecondHover" class="color-picker_btn_two colGradientColorSecondHover" data-alpha='true' id="colGradientColorSecondHover" value=''>
                                        <p>Location</p>
            ...
            <div>
                ...
                <div class="responsiveOps responsiveOptionsContainterLarge">
                  <input type="number" name="columnMarginTop" class=" padding_inline_inp linkedField columnMarginTop colOptionsFields" id="columnMarginTop" value='0' placeholder="Top" >
                   
                  <input type="number" name="columnMarginBottom" class=" padding_inline_inp linkedField columnMarginBottom colOptionsFields" id="columnMarginBottom" value='0' placeholder="Bottom">
                     
                  <input type="number" name="columnMarginLeft" class=" padding_inline_inp linkedField columnMarginLeft colOptionsFields" id="columnMarginLeft" value='0' placeholder="Left">
                     
                  <input type="number" name="columnMarginRight" class=" padding_inline_inp linkedField columnMarginRight colOptionsFields" id="columnMarginRight" value='0' placeholder="Right">

                  <span class="linkfieldBtn colLinkBtn linkBtn" > <i class="fa fa-link"></i> </span>
                </div>
                <div class="responsiveOps responsiveOptionsContainterMedium" style="display: none;">
                  <input type="number" name="columnMarginTopTablet" class="padding_inline_inp linkedField  columnMarginTopTablet colOptionsFields" id="columnMarginTopTablet"  placeholder="Top" >
                  
                  <input type="number" name="columnMarginBottomTablet" class="padding_inline_inp linkedField  columnMarginBottomTablet colOptionsFields" id="columnMarginBottomTablet"  placeholder="Bottom">
                  
                  <input type="number" name="columnMarginLeftTablet" class="padding_inline_inp linkedField  columnMarginLeftTablet colOptionsFields" id="columnMarginLeftTablet"  placeholder="Left">
                  
                  <input type="number" name="columnMarginRightTablet" class="padding_inline_inp linkedField  columnMarginRightTablet colOptionsFields" id="columnMarginRightTablet"  placeholder="Right">

                  <span class="linkfieldBtn colLinkBtn linkBtn" > <i class="fa fa-link"></i> </span>
                </div>
                <div class="responsiveOps responsiveOptionsContainterSmall" style="display: none;">
                  <input type="number" name="columnMarginTopMobile" class="padding_inline_inp linkedField  columnMarginTopMobile colOptionsFields" id="columnMarginTopMobile"  placeholder="Top" >
                  
                  <input type="number" name="columnMarginBottomMobile" class="padding_inline_inp linkedField  columnMarginBottomMobile colOptionsFields" id="columnMarginBottomMobile"  placeholder="Bottom">
                  
                  <input type="number" name="columnMarginLeftMobile" class="padding_inline_inp linkedField  columnMarginLeftMobile colOptionsFields" id="columnMarginLeftMobile"  placeholder="Left">
                  
                  <input type="number" name="columnMarginRightMobile" class="padding_inline_inp linkedField  columnMarginRightMobile colOptionsFields" id="columnMarginRightMobile"  placeholder="Right">
            ...
            <div>
                ...
                <div class="responsiveOps responsiveOptionsContainterLarge">
                  <input type="number" name="columnPaddingTop" class=" padding_inline_inp linkedField columnPaddingTop colOptionsFields" id="columnPaddingTop" value='0' placeholder="Top" >
                
                  <input type="number" name="columnPaddingBottom" class=" padding_inline_inp linkedField columnPaddingBottom colOptionsFields" id="columnPaddingBottom" value='0' placeholder="Bottom">
                  
                  <input type="number" name="columnPaddingLeft" class=" padding_inline_inp linkedField columnPaddingLeft colOptionsFields" id="columnPaddingLeft" value='0' placeholder="Left">
                  
                  <input type="number" name="columnPaddingRight" class=" padding_inline_inp linkedField columnPaddingRight colOptionsFields" id="columnPaddingRight" value='0' placeholder="Right">

                  <span class="linkfieldBtn colLinkBtn linkBtn" > <i class="fa fa-link"></i> </span>
                </div>
                <div class="responsiveOps responsiveOptionsContainterMedium" style="display: none;">
                  <input type="number" name="columnPaddingTopTablet" class="padding_inline_inp linkedField  columnPaddingTopTablet colOptionsFields" id="columnPaddingTopTablet"  placeholder="Top">
                  
                  <input type="number" name="columnPaddingBottomTablet" class="padding_inline_inp linkedField  columnPaddingBottomTablet colOptionsFields" id="columnPaddingBottomTablet"  placeholder="Bottom">
                  
                  <input type="number" name="columnPaddingLeftTablet" class="padding_inline_inp linkedField  columnPaddingLeftTablet colOptionsFields" id="columnPaddingLeftTablet"  placeholder="Left">
                  
                  <input type="number" name="columnPaddingRightTablet" class="padding_inline_inp linkedField  columnPaddingRightTablet colOptionsFields" id="columnPaddingRightTablet"  placeholder="Right">

                  <span class="linkfieldBtn colLinkBtn linkBtn" > <i class="fa fa-link"></i> </span>
                </div>
                <div class="responsiveOps responsiveOptionsContainterSmall" style="display: none;">
                  <input type="number" name="columnPaddingTopMobile" class="padding_inline_inp linkedField  columnPaddingTopMobile colOptionsFields" id="columnPaddingTopMobile"  placeholder="Top">
                  
                  <input type="number" name="columnPaddingBottomMobile" class="padding_inline_inp linkedField  columnPaddingBottomMobile colOptionsFields" id="columnPaddingBottomMobile"  placeholder="Bottom">
                  
                  <input type="number" name="columnPaddingLeftMobile" class="padding_inline_inp linkedField  columnPaddingLeftMobile colOptionsFields" id="columnPaddingLeftMobile"  placeholder="Left">
                  
                  <input type="number" name="columnPaddingRightMobile" class="padding_inline_inp linkedField  columnPaddingRightMobile colOptionsFields" id="columnPaddingRightMobile"  placeholder="Right">
              ...
              <div class="PB_accordion">
                ...
                <div>
                    <div class="pbp_form" style="width: 100%;">
                      ...
                      <input type="number" class="colBorderWidth colOptionsFields">px
                      <br>
                      <br>
                      <label>Border Style : </label>
                      <select class="colBorderStyle colOptionsFields">
                      ...
                      <input type="text" id="colBorderColor" class="color-picker_btn_two  colBorderColor colOptionsFields">
                      <br>
                      <label>Corner Radius : </label>
                      <input type="number" class="colBorderRadius colOptionsFields">px
                      <br>
                      <hr>
                      <br>
                      <br>
                    ...
                    if($proWidgetLoaded == false) {
                        ?>
                          <div style="display: inline-block; width: 49%; float: left;">
                            ...
                            <div class="widget POPB_widget prem-widget" data-widgType="wigt-pb-iconList"> <i class="fa fa-list"></i> <br> Icon List <p>Pro Only</p></div>
                          ...
                          <div style="display: inline-block; width: 49%;">
                            ...
                            <div class="widget POPB_widget prem-widget" data-widgType="wigt-pb-cards"><i class="fa fa-fonticons"></i> <br> Card <p>Pro Only</p></div>
                          ...
                          <br><br><br> <a href="https://pluginops.com/optin-builder/?ref=widgets" target="_blank" style="padding:5px 10px; text-decoration: none; font-size: 17px; text-align: center; color: #fff; background:#8BC34A; border-radius: 3px;"> Unlock All These Amazing Widgets </a> <br>
                        <?php
                    }
                ?>
