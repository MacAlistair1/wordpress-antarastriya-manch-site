...
5. Pro Version admin can set color of title and Description
6. Pro Version admin can set font size and Description
7. Admin can set any post or page as a news no need to add edit news manually.
8. Go to add or edit post or page and checkbox check add this post or page as news.
9. Go to add or edit post or page and checkbox check add this post or page as news.
10. Vertical News Scroller Open news link in same window Or In new tab
